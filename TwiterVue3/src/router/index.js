...
const routes = [
    {path: '/', component : Home, title: '홈', icon:'fa-solid fa-house fa-fw text-2xl', meta:{isMenu: true, layout:'DefaultLayout'}},
    {path: '/', component : Home, title: '탐색하기', icon:'fa-solid fa-hashtag fa-fw text-2xl', meta:{isMenu: true, layout:'DefaultLayout'}},
    ...
    {path: '/', component : Home, title: '더보기', icon:'fas fa-ellipsis-h fa-fw text-2xl', meta:{isMenu: true, layout:'DefaultLayout'}},
